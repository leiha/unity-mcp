...
async def manage_asset(
    ...
    asset_type: Annotated[str | None,
                          "Asset type (e.g., 'Material', 'Folder') - required for 'create'. Note: For ScriptableObjects, use manage_scriptable_object."] = None,
    properties: Annotated[dict[str, Any] | str | None,
                          "Dictionary of properties for 'create'/'modify'. Keys are property names, values are property values."] = None,
    destination: Annotated[str | None,
                           "Target path for 'duplicate'/'move'."] = None,
    ...
    search_pattern: Annotated[str | None,
                              "Search pattern (e.g., '*.prefab' or AssetDatabase filters like 't:MonoScript'). "
                              "Recommended: put queries like 't:MonoScript' here and set path='Assets'."] = None,
    filter_type: Annotated[str | None, "Filter type for search"] = None,
    filter_date_after: Annotated[str | None,
                                 "Date after which to filter"] = None,
    page_size: Annotated[int | float | str | None,
                         "Page size for pagination. Recommended: 25 (smaller for LLM-friendly responses)."] = None,
    page_number: Annotated[int | float | str | None,
                           "Page number for pagination (1-based)."] = None,
) -> dict[str, Any]:
