...
async def run_tests(
    ...
    test_names: Annotated[list[str] | str | None,
                          "Full names of specific tests to run"] = None,
    group_names: Annotated[list[str] | str | None,
                           "Same as test_names, except it allows for Regex"] = None,
    category_names: Annotated[list[str] | str | None,
                              "NUnit category names to filter by"] = None,
    assembly_names: Annotated[list[str] | str | None,
                              "Assembly names to filter tests by"] = None,
